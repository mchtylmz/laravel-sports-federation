...
!function () {
    ...
    class e {
        static addEvent() {
            let e = document.querySelector(".js-add-event"), t = "";
            document.querySelector(".js-form-add-event").addEventListener("submit", (a => {
                if (a.preventDefault(), t = e.value, t) {
                    let a = document.getElementById("js-events"), n = document.createElement("li"),
        ...
        static initCalendar() {
            ...
            new FullCalendar.Calendar(document.getElementById("js-calendar"), {
                ...
                events: [{title: "Gaming Day", start: new Date(n, a, 1), allDay: !0}, {
                    title: "Skype Meeting",
                    ...
                    allDay: !0,
                    color: "#82b54b"
                }, {id: 999, title: "Hiking (repeated)", start: new Date(n, a, t - 1, 15, 0)}, {
                    id: 999,
                    ...
                    allDay: !0,
                    color: "#ffb119"
                }, {title: "Lunch", start: new Date(n, a, t + 7, 15, 0), color: "#82b54b"}, {
                    title: "Coding",
